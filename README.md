...
Passo 2: Executar o Script de Extração de Dados (python | python3 inteligencia_ltda_proj.py)

Passo 3: Executar o Script de Visualização de Dados (python | python3 inteligencia_ltda_proj.py)
